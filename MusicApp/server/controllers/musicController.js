const { Song, SearchHistory } = require('../models');
const { searchMusic, searchMusicByMood, getTrackLyrics, generateTrackExplanation } = require('../helpers/externalApis');
...
exports.searchByMood = async (req, res, next) => {
  try {
...
exports.generateSongLyrics = async (req, res, next) => {
  try {
